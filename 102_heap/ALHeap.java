...
DISCO:
* We can use a parentPos() helper function to help calculate (p-1) / 2.
* We can insert nulls to represent empty node cells in the ArrayList.

QCC:
* Why do we get duplicate elements?
